...
def main():
  ...
  argparser = argparse.ArgumentParser(description='Run Jobs from JSON config')
  argparser.add_argument('--name', type=str, default='test_job_system', help='name of the JSON config to use')
